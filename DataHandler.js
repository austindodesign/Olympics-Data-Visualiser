...
function parseSafeNum(val) {
  if (val === "n/a" || val === "" || val === "NA") return null;
...
function loadOlympicsData() {
  if (!olympicsTablePart1 || !olympicsTablePart2 || !olympicsTablePart3) return;

  let combinedRows = [...olympicsTablePart1.rows, ...olympicsTablePart2.rows, ...olympicsTablePart3.rows];
